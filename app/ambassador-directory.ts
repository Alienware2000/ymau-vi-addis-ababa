...
export const ambassadorDirectory: AmbassadorRecord[] = [
  ...
  {
    slug: "mienclo-jatniel-ana-s-kouakou",
  ...
  {
    slug: "miendjiem-kemo-hilary-s-gol-ne",
