...
export const currentPartners: PartnerRecord[] = [
  {
    ...
    logoSrc: "/ymau-media/partners/african-union.png",
...
export const ymauVPartners: PartnerRecord[] = [
  ...
  { name: "African Union", archiveGroup: "Gold sponsor", logoSrc: "/ymau-media/partners/african-union.png", logoAlt: "African Union emblem", blurb: "Gold institutional sponsor of YMAU V in Accra." },
  ...
  { name: "MTN Pulse", archiveGroup: "Gold sponsor", logoSrc: "/ymau-media/partners/mtn-pulse.png", logoAlt: "MTN Pulse logo", blurb: "Gold sponsor of YMAU V in Accra." },
  { name: "KCB Group", archiveGroup: "Silver sponsor", logoSrc: "/ymau-media/partners/kcb-group.png", logoAlt: "KCB Group logo", blurb: "Silver sponsor of YMAU V in Accra." },
